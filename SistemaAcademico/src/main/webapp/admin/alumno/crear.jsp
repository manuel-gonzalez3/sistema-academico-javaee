<%-- Formulario de alta de alumno. Llamado desde AdminCrearPersona con ?rol=alumno.
...
<div class="container-page">
  <div class="header">
    <h1 class="header-title">Crear Alumno</h1>
  </div>
  ...
  <div class="card card--p">
    <form method="post" action="<%= cp %>/persona/crear" class="form">
      ...
      <div class="toolbar mt-3">
        ...
        <a class="btn btn-outline" href="<%= cp %>/alumno/listar">
          Cancelar
        </a>
      </div>
    </form>
